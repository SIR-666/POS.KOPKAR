          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="">
              <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                <img src="<?php echo base_url('assets/production/') ?>images/user.png" alt=""> <span style="color: white;"><?php echo $user['nama_lengkap'] ?></span>
                <span class=" fa fa-angle-down"></span>
              </a>
              <ul class="dropdown-menu dropdown-usermenu pull-right">
                <li><a href="<?php echo site_url('user/change_password') ?>"><i class="fa fa-key pull-right"></i> Ubah Password</a></li>
