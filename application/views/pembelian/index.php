...
<div class="right_col" role="main">
	<div class="">
		...
		<form class="form-horizontal" method="post" action="<?php echo site_url('pembelian/tambahbeli') ?>">
			<div class="row">
					...
					<div class="x_panel">
						...
						<div class="x_content">
							...
							<div class="form-group">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<input type="text" class="form-control" name="nofaktur" id="nofaktur" autocomplete="off" value="<?= date('ymdhi') ?>">
									<small><i>*silahkan ubah sesuai nomor faktur dari supplier</i></small>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<span class="input-group-btn">
										...
										<a href="<?= site_url('barang') ?>" target=_blank class="btn btn-warning" title="tambah produk baru"><i class="fa fa-plus"></i></a>
									</span>
								</div>
							</div>
							<div class="form-group">
