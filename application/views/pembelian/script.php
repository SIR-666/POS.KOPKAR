<script>
    ...
    function tampilsupplier() {
        $('#daftarsupplier').DataTable({
            ...
            "bJQueryUI": true,
            "sPaginationType": "full_numbers",
            "sAjaxSource": '<?= site_url('supplier/LoadData') ?>',
            "sAjaxDataProp": "aaData",
            "fnRender": function(oObj) {
                uss = oObj.aData["Username"];
            },
    ...
    function pilihsupplier(e) {
        $.ajax({
            url: '<?= site_url("supplier/detilsupplier/") ?>' + e,
            type: "post",
            success: function(data) {
                var obj = JSON.parse(data);
    ...
    function addBeliByClick() {
        ...
        if ($('#namaitembeli').val() == "" || qty == "" || beli == "" || jual == "") {
            ...
            $.ajax({
                url: '<?= site_url("pembelian/tambahbeli/") ?>' + id + '/' + qty + '/' + subtotal + '/' + jual + '/' + beli,
                type: "post",
                success: function(data) {
                    var obj = JSON.parse(data);
                    LoadItemBeli();
    ...
    function LoadItemBeli() {
        $('#detilitembeli').DataTable({
            ...
            "bJQueryUI": true,
            "sPaginationType": "full_numbers",
            "sAjaxSource": '<?= site_url('pembelian/LoadData') ?>',
            "sAjaxDataProp": "aaData",
            "ordering": false,
            "fnRender": function(oObj) {
                uss = oObj.aData["Username"];
    ...
    function hapusDetilBeli(e) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: '<?= site_url("pembelian/hapusdetil/") ?>' + e,
                    type: "post",
                    success: function(data) {
                        LoadItemBeli();
                        var obj = JSON.parse(data);
    ...
    function editDetilBeli(e) {
        ...
        $.ajax({
            url: '<?= site_url("pembelian/detilitembeli/") ?>' + e,
            type: "post",
            success: function(data) {
                var obj = JSON.parse(data);
    ...
    function updateDetilBeli() {
        ...
        $.ajax({
            url: '<?= site_url("pembelian/editdetilbeli/") ?>' + id + '/' + qty + '/' + subtotal,
            type: "post",
            success: function(data) {
                LoadItemBeli();
                var stok = qty - qty1;
                ...
                $.ajax({
                    url: '<?= site_url("pembelian/hargatotal") ?>',
                    type: "post",
                    success: function(data) {
                        var obj = JSON.parse(data);
                        $('#grandtotalbeli').text(obj.subtotal);
    ...
    function pilih_metode_beli(value) {
