  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <!-- <a href="<?php //echo site_url('hutang/add')
                ...
                <tr>
                  ...
                  <td>
                    <?php if ($val['status'] == 'Lunas') { ?>
                      ...
                      <?php } else { ?>
                      <a href="<?php echo site_url('hutang/payment/' . encrypt_url($val['id_hutang'])) ?>" class="btn btn-success btn-xs"><i class="fa fa-check"></i> Payment</a>
                    <?php } ?>
