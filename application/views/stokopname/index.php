		...
		<div class="">
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<a href="<?php echo site_url('stokopname/entry') ?>" class="btn btn-sm btn-primary" title="Tambah Data" id="tambahmutasi"><i class="fa fa-plus"></i> Tambah Data</a>
								...
								<tbody>
									<?php foreach ($opname as $o) { ?>
										<tr>
											...
											<td>
												<a href="<?php echo site_url('stokopname/edit/') . encrypt_url($o['id_stok_opname']) ?>" class="btn btn-primary btn-xs" title="Edit Data"><i class="fa fa-edit"></i></a>
