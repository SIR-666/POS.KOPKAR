             ...
             <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="x_panel">
                 ...
                 <div class="x_content">
                   ...
                   <form class="form-horizontal" method="post" action="<?php echo site_url('report/laba_kotor') ?>">
             ...
             <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="x_panel">
                 ...
                 <div class="x_content">
                   ...
                   <form class="form-horizontal" method="post" action="<?php echo site_url('report/laba_bersih') ?>">
                     <div class="form-group">
                       <div class="col-md-6 col-sm-6 col-xs-12">
                         <label for="">Tanggal Awal :</label>
                         <input type="date" id="awal" class="form-control datepicker" name="awal" required />
