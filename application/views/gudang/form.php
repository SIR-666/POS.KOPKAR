                    ...
                    <div class="x_content">
                        <form class="form-horizontal" method="post" action="<?php echo site_url($action) ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" name="stok_gudang" id="stok_gudang" readonly value="<?= $item['stok'] ?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div style="text-align: right">
                                <a href="<?= site_url('gudang') ?>" class="btn btn-danger"><i class="fa fa-recycle m-right-xs"></i> Batal</a>
